...
def restaurerGraphe():
    fichier = tkinter.filedialog.askopenfile() #ouvrir un fichier
    if fichier == None:                                                             
        return
        
    try:
        print(fichier.read()) #afficher et lire le fichier    
    except:
        print("Le fichier n'existe pas ou ne peut pas être ouvert")

    fichier.close() #terminer la lecture du fichier au niveau du code
